...
**Encriptador de Texto** es una aplicación web interactiva desarrollada en **JavaScript**, **HTML** y **CSS**. Su propósito es permitir a los usuarios encriptar y desencriptar mensajes de texto utilizando un conjunto específico de reglas de sustitución, facilitando el intercambio de mensajes de manera segura y divertida.
